...
class Subscription(models.Model):
    ...
    def create_for_school(cls, school, plan_type: str) -> 'Subscription':
        ...
        plan_obj = SubscriptionPlan.objects.filter(plan_type=plan_type, is_active=True).first()
...
# Import billing models so Django discovers them as part of this app
from .billing_models import BillingCycle, Invoice, PaymentFailure, DunningProcess, RefundRequest  # noqa: F401, E402
