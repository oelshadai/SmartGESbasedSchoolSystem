                ...
                safeData.assigned_classes.map((cls) => (
                  <div key={cls.id} className="flex items-center justify-between py-2 border-b border-border last:border-0">
                    <div>
                      ...
                      <p className="text-xs text-foreground/60">{cls.level} · {cls.students_count} students</p>
                    </div>
                  </div>
                ))
              ) : (
                <p className="text-sm text-foreground/60">No classes assigned</p>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="animated-border-content p-4 sm:p-6">
            ...
            <div className="space-y-3">
              {safeData.announcements.length > 0 ? (
                ...
                <p className="text-sm text-foreground/60">No announcements</p>
              )}
            </div>
          </div>
        </div>
                ...
                safeData.teaching_subjects.map((subj) => (
                  <div key={subj.id} className="flex items-center justify-between py-2 border-b border-border last:border-0">
                    <div>
                      ...
                      <p className="text-xs text-foreground/60">{subj.class}</p>
                    </div>
                  </div>
                ))
              ) : (
