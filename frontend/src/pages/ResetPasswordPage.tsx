    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4">
      <div className="bg-slate-900/80 border border-slate-700/50 rounded-3xl p-8 w-full max-w-sm shadow-2xl">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-slate-200 text-sm mt-1">Enter your new password below</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative mt-1">
                <Input
                  ...
                  required
                  className="bg-slate-800/50 border-slate-700 text-white placeholder:text-slate-200 focus:border-orange-500 pr-10"
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <Input
                ...
                required
                className="mt-1 bg-slate-800/50 border-slate-700 text-white placeholder:text-slate-200 focus:border-orange-500"
              />
            </div>
            ...
            <button
              ...
              className="w-full text-sm text-slate-200 hover:text-slate-200 transition-colors"
            >
              Back to Login
            </button>
          </form>
