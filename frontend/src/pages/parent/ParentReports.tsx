  ...
  return (
    <div className="space-y-6 p-4 sm:p-6 animate-fade-in">
      <div>
        ...
        <p className="text-foreground text-sm mt-1">View your child's term reports and report cards</p>
      </div>
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        ...
                        <p className="text-xs text-foreground mt-0.5">{r.class_name}</p>
                      </div>
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        {r.subjects.map((s, i) => (
                          <div key={i} className="flex items-center justify-between gap-3 rounded-lg bg-muted/40 px-3 py-2">
                            <div className="min-w-0 flex-1">
                              <p className="text-sm font-medium truncate text-foreground">{s.subject_name}</p>
