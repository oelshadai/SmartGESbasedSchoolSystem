  ...
  return (
    <div className="space-y-6 p-4 sm:p-6 animate-fade-in">
      <div>
        ...
        <p className="text-foreground text-sm mt-1">View your child's academic results</p>
      </div>
              ...
              <CardContent className="p-4">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                  <div>
                    ...
                    <p className="font-semibold text-sm text-foreground">{activeTermResult.class_name}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-foreground">{activeTermResult.subjects_count}</p>
                  </div>
                </div>
                  ...
                  <div key={r.id} className="rounded-lg border p-3">
                    <div className="flex items-center justify-between gap-3">
                      <div className="min-w-0 flex-1">
                        <p className="font-medium text-sm truncate text-foreground">{r.subject_name}</p>
