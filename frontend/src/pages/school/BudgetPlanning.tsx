...
export default function BudgetPlanning() {
  ...
  const fetchBudgets = async () => {
    try {
      ...
      const budgetsData = Array.isArray(response) ? response : response?.results || response?.data || [];
            ...
            <Card key={budget.id}>
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-sm text-foreground/70">FY {budget.fiscal_year}</p>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    <p className="text-sm text-foreground/70">Utilized</p>
