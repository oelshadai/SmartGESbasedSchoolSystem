...
const StaffPermissions = () => {
  ...
  if (loading) {
    return (
      <div className="p-8 flex items-center justify-center gap-2 text-foreground/60">
    ...
    <div className="space-y-6 animate-fade-in p-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-foreground/70">Assign special fee collection and attendance cover roles to teachers</p>
        </div>
      </div>
          ...
          <button
            ...
            className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium border transition-colors ${
              activeTab === key
                ...
                : 'bg-white border-gray-200 text-foreground hover:border-primary hover:text-primary'
            }`}
          >
            {icon}{label}
          </button>
          ...
          <Card>
            <CardContent className="pt-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  {masterToggling && <Loader2 className="h-4 w-4 animate-spin text-foreground/60" />}
                  <Switch
            ...
            <CardContent className="space-y-3">
              ...
              {addingFee && (
                <div className="rounded-lg border border-primary/30 bg-muted/20 p-4 space-y-3">
                  ...
                  <div className="space-y-1">
                    <Label>Fee Types <span className="text-foreground/60 font-normal text-xs">(leave all unchecked = all active types)</span></Label>
              ...
              {feePerms.length === 0 && !addingFee && (
                <p className="text-sm text-foreground/60 text-center py-4">No special fee collectors assigned yet.</p>
              )}
                  ...
                  <div key={perm.id} className="rounded-lg border p-3 space-y-2">
                    <div className="flex items-center justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-foreground/60">{perm.teacher_email}</p>
                      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {financePerms.length === 0 && !addingFinance && (
              <p className="text-sm text-foreground/60 text-center py-4">No bursar / financial manager assigned yet.</p>
            )}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {coverPerms.length === 0 && !addingCover && (
              <p className="text-sm text-foreground/60 text-center py-4">No cover teachers assigned yet.</p>
            )}
