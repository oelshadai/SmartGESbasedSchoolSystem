  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
      ...
      <div>
        ...
        <p className="text-foreground/70 mt-1">Manage your school's subscription plan.</p>
      </div>
      ...
      <div className={cn(
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            {endDate && (
              <p className="flex items-center gap-1 text-sm text-foreground/70 mt-1">
            ...
            {currentPlan !== 'MONTHLY' && currentPlan !== 'YEARLY' && (
              <div className="rounded-xl border-2 border-primary p-5 space-y-4">
                <div>
                  ...
                  <p className="text-3xl font-extrabold text-foreground">GH₵ 200</p>
            ...
            {currentPlan !== 'YEARLY' && (
              <div className="rounded-xl border-2 border-secondary p-5 space-y-4 relative overflow-hidden">
                ...
                <div>
                  ...
                  <p className="text-3xl font-extrabold text-foreground">GH₵ 2,200</p>
                  <p className="text-sm text-foreground/60">per year · pay 11 months</p>
                </div>
                <ul className="space-y-1.5 text-sm text-foreground/80">
