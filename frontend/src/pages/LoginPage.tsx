...
const LoginPage = () => {
  ...
  return (
    <div className="flex h-screen relative overflow-hidden">
      ...
      {/* Left panel */}
      <div className="hidden lg:flex lg:w-1/2 bg-slate-950 items-center justify-center p-8 xl:p-12 relative">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_40%,rgba(56,189,248,0.18),transparent_60%)]" style={{ zIndex: 2 }} />
        <div className="relative z-10 max-w-md space-y-6 text-slate-100">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-4 sm:p-8 bg-background">
        <div className="w-full max-w-md space-y-2 sm:space-y-4">
          ...
          <div className="space-y-0.5 text-center">
              <h2 className="text-base sm:text-2xl font-bold text-white">Welcome back</h2>
              <p className="text-xs sm:text-sm text-slate-300">Sign in to continue</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-2 sm:space-y-3">
            ...
            <Button 
              type="button" 
              variant="outline" 
              className="w-full h-9 sm:h-10 text-xs sm:text-sm border-cyan-500/40 text-cyan-200 hover:text-white hover:border-cyan-500 hover:bg-slate-900/60"
