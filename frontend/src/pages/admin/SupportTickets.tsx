...
const statusConfig: Record<string, { bg: string; text: string; icon: any }> = {
  ...
  closed: { bg: 'bg-gray-500/20', text: 'text-foreground/60', icon: XCircle },
};
      ...
      <div className="relative p-4 sm:p-6 space-y-6 sm:space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-foreground/70 text-lg">Manage support requests from schools and users</p>
          </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 overflow-hidden">
          <div className="p-6 border-b border-slate-800/50">
            ...
            <p className="text-foreground/70 text-sm mt-1">Manage and respond to support requests</p>
          </div>
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-2 ml-4">
                      ...
                      <Button 
                        variant="ghost" 
                        size="icon" 
                        className="h-8 w-8 text-foreground/70 hover:text-purple-400 hover:bg-purple-500/10"
                      >
          ...
          {filteredTickets.length === 0 && (
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-foreground/70 mb-2">No tickets found</h3>
