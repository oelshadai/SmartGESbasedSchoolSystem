      ...
      <div className="relative p-4 sm:p-6 space-y-6 sm:space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-foreground/70 text-lg">Manage users across all schools and platforms</p>
          </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        ...
                        <p className="text-xs text-foreground/70 mt-1">{user.school}</p>
                      </div>
          ...
          {filteredUsers.length === 0 && (
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-foreground/70 mb-2">No users found</h3>
