    ...
    <div className="relative p-4 sm:p-6 space-y-6 sm:space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-foreground/70 text-lg">Platform-wide analytics and performance metrics</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="bg-slate-900/50 backdrop-blur-xl rounded-xl border border-slate-800/50 px-4 py-2">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
              <span className="text-sm text-foreground/60">Real-time Data</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-foreground/70 text-sm">Based on overall performance metrics</p>
            </div>
          </div>
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs text-foreground/70">{school.students} students</p>
                      </div>
                    </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-foreground/70 text-sm">User distribution across platform</p>
            </div>
          </div>
          <div className="space-y-4">
              ...
              <div key={item.role} className="p-3 rounded-xl bg-slate-800/30">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="text-right">
                    ...
                    <span className="text-foreground/70 text-sm ml-1">({item.percentage}%)</span>
                  </div>
                </div>
                <div className="h-2 bg-slate-700/50 rounded-full overflow-hidden">
                  <div 
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={m.label} className="flex justify-between items-center py-2 border-b border-slate-800/50 last:border-0">
                <span className="text-foreground/60 text-sm">{m.label}</span>
                <div className="text-right">
