      ...
      <div className="relative p-6 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-foreground/70 text-lg">Create and manage schools on the platform</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-11 h-12 bg-slate-800/50 border-slate-700/50 text-white placeholder:text-foreground/70 focus:border-blue-500 focus:ring-blue-500/20"
              />
            </div>
            <div className="flex gap-3">
              ...
              <Button variant="outline" className="h-12 bg-slate-800/50 border-slate-700/50 text-foreground/60 hover:bg-slate-800 hover:text-white">
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-800/50 overflow-hidden">
          <div className="p-6 border-b border-slate-800/50">
            ...
            <p className="text-foreground/70 text-sm mt-1">Manage school accounts and subscriptions</p>
          </div>
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="flex items-center gap-4 text-sm">
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-xs text-foreground/70">Teachers</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex items-center gap-1">
                          <Button 
                            variant="ghost" 
                            size="icon" 
                            className="h-8 w-8 text-foreground/70 hover:text-blue-400 hover:bg-blue-500/10"
                          >
                          ...
                          <Button 
                            variant="ghost" 
                            size="icon" 
                            className="h-8 w-8 text-foreground/70 hover:text-green-400 hover:bg-green-500/10"
                          >
                          ...
                          <Button 
                            variant="ghost" 
                            size="icon" 
                            className="h-8 w-8 text-foreground/70 hover:text-red-400 hover:bg-red-500/10"
                          >
                          ...
                          <Button 
                            variant="ghost" 
                            size="icon" 
                            className="h-8 w-8 text-foreground/70 hover:text-foreground/60 hover:bg-slate-700/50"
                          >
          ...
          {filteredSchools.length === 0 && (
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-foreground/70 mb-2">No schools found</h3>
