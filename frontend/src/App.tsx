...
const AdminSystemHealth          = lazy(() => import("./pages/superadmin/AdminSystemHealth"));
const AdminBillingDashboard      = lazy(() => import("./pages/superadmin/AdminBillingDashboard"));
...
const PageLoader = () => (
  <div className="flex items-center justify-center min-h-screen bg-[#0a0f1a]">
    <div className="flex flex-col items-center gap-3">
      ...
      <p className="text-slate-100 text-xs tracking-widest uppercase">Loading…</p>
    </div>
  </div>
);
    ...
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        ...
        <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          ...
          {/* Super Admin */}
          <Route element={<ProtectedRoute allowedRoles={['SUPER_ADMIN']}><ProfessionalAdminLayout /></ProtectedRoute>}>
          ...
          {/* Teacher */}
          <Route element={<ProtectedRoute allowedRoles={['TEACHER']}><ProfessionalAdminLayout /></ProtectedRoute>}>
          ...
          {/* Student */}
          <Route element={<ProtectedRoute allowedRoles={['STUDENT']}><ProfessionalAdminLayout /></ProtectedRoute>}>
          ...
          {/* Parent */}
          <Route element={<ProtectedRoute allowedRoles={['PARENT']}><ProfessionalAdminLayout /></ProtectedRoute>}>
