      ...
      <div className="bg-white rounded-lg w-[95vw] h-[95vh] flex flex-col max-w-7xl">
        <div className="flex flex-wrap justify-between items-center gap-2 p-3 border-b">
          <div className="flex items-center gap-2 min-w-0">
            ...
            {currentStudent && (
              <span className="text-sm text-foreground hidden sm:inline truncate">
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            ...
            <Button variant="ghost" size="sm" onClick={onClose} className="px-2 text-foreground/70 hover:text-gray-700">
              <X className="w-5 h-5" />
            </Button>
          </div>
        </div>
